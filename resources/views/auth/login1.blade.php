        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <div class="content d-flex justify-content-center align-items-center mt-3">
                    ...
                    <button class="btn btn-lg btn-registerBtn regButtonResOwn" type="button">Register for Store</button>
                </div>
            </div>
        </div>
    </form>
        ...
        <div class="card mb-0">
            <div class="card-body">
                <div class="text-center mb-3">
                    ...
                    <h5 class="mb-0">Registration for <span id="regFor">Store Owner</span></h5>
