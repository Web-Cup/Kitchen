...
<div class="swal2-container swal2-fade" style="overflow-y: auto;overflow-x: hidden;display:none">
          ...
          .done(function(newArray) {
              ...
              if (newArray.length > 0) {
                  ...
                  $.map(newArray, function(order, index) {
                      ...
                      newOrderData += '<button class="btn btn-default btn-labeled btn-lg mr-2 stopSound" data-popup="tooltip" data-placement="right" title="{{ __('storeDashboard.dashboardStopSound') }}" style="background-color: #F5F5F5;"><i class="icon-volume-mute5"></i></button>';
                      Swal.fire({postion: 'center',html: newOrderData,type:"success",showConfirmButton: false});
